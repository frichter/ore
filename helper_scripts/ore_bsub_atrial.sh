...
## norm
mv atrial_ore_small_vcf_all_data.txt atrial_data/atrial_ore_all_data_lt500_SV5_utr5.txt
mv atrial_ore_small_vcf_rv_w_outliers.txt atrial_data/atrial_ore_rv_w_outliers_lt500_SV5_utr5.txt 
