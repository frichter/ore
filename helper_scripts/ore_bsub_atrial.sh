...
OUTLIER_OUT="$PARENT_DIR/atrial_ore_SV${SV}_outliers_norm_customIDrm.txt"
...
VAR_CLASS="UTR5"
ENRICH_F="$PARENT_DIR/atrial_enrich/atrial_enrich_norm_${VAR_CLASS}_SV${SV}_customIDrm.txt"
# ore_per_anno_
